...
@interface DMNewPopWindowController ()
@property (nonatomic, strong) NSView *itemsTable;

@end

@implementation DMNewPopWindowController
...
- (void)loadHeightsWithWindowOrigin:(NSPoint)point {
    ...
    int sizeOfCellsInTableView = 178;
    ...
    sizeOfCellsInTableView = MIN(178,sizeOfCellsInTableView);
